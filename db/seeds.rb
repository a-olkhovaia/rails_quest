...
#   q.status      = "accepted"
#   q.accepted_at = Time.current
# end
# QuestProgress.find_or_create_by!(quest_number: 2) do |q|
#   q.status      = "unlocked"
...
# ============================================
# Rails Quest - Seeds
# Инициализация прогресса квестов
# ============================================

# Очищаем существующие записи
QuestProgress.delete_all

# Создаём записи для всех 5 квестов
QuestProgress.create!(quest_number: 1, status: "accepted", accepted_at: Time.current)
QuestProgress.create!(quest_number: 2, status: "unlocked", unlocked_at: Time.current)
QuestProgress.create!(quest_number: 3, status: "locked")
QuestProgress.create!(quest_number: 4, status: "locked")
QuestProgress.create!(quest_number: 5, status: "locked")

puts "✅ Quest progress seeded successfully!"
puts "   Quest 1: accepted"
puts "   Quest 2: unlocked"
puts "   Quest 3: locked"
puts "   Quest 4: locked"
puts "   Quest 5: locked"